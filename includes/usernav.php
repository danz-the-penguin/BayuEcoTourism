<div class="usernav">
    ...
    <div class="search-container">
        <form action="<?php echo BASE_URL; ?>search.php" method="post">
            <input type="search" placeholder="Search animal" name="search_text" size="50" required>
    ...
    <div class="user-links">
        <?php if (isset($_SESSION["UID"])) { ?>
            ...
            <!-- Edit Profile Button -->
            <a href="javascript:void(0);" onclick="openEditPopup()" class="cart-button">
                <i class="fa fa-user" style="font-size:24px;" title="Edit Profile"></i>
            </a>
        ...
        <?php } ?>
        <?php
        echo '<a href="ticket_action.php" title="My Cart"><i class="fa fa-shopping-cart" style="font-size:24px"></i></a> ';
